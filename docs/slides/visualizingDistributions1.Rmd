...
author: "Roy Thomas - Adapted from Claus Wilke course"
...
- ggplot(titanic, aes(x = age)) + geom_density(fill = "skyblue", bw = 5, kernel = "gaussian")
- ggplot(titanic, aes(x = age)) + geom_density(fill = "skyblue", bw = 2, kernel = "rectangular")
...
```
Is the female bar over the male bar?  (In this case, yes.  This is a "stacked" column.)
]
